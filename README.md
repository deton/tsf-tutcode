...
| 打鍵ヘルプ表示タイミング                  | [打鍵ヘルプ](#打鍵ヘルプ)をいつ表示するか |
...
* 「漢字表」: 記憶をリフレッシュできるように、似た打鍵で打てる文字も合わせて表示。ヘルプ表示対象文字のストロークに関して、最初の打鍵が異なる文字を含めて鍵盤レイアウトで並べて表示。
  ![](installer/resource-md/251_kanjihyo.png)
